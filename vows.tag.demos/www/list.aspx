...
<body>
    <div class="head">
        <asp:PlaceHolder ID="LabelTag_16598_3" runat="server"></asp:PlaceHolder><!--引入label-->
    </div>
    <div class="navi">
        <ul class="navilist">
    <li><a href="/">首页</a></li>
    ...
    <div class="main">
        <div class="location">
            当前位置：<a href="index.aspx"><% = config.webname %></a>
                        &gt;<a><% =ReadTag_31997_6.Name %></a>
                    </div>
        <div class="articles">
            <ul class="articlelist">
                
<asp:Repeater ID="ListTag_7319_8" runat="server">
    <ItemTemplate><!--每页显示4条->
...
<asp:Literal ID="empty_ListTag_7319_8" runat="server"></asp:Literal>
