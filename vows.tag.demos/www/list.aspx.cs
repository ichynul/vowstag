...
{
    protected Category ReadTag_31286_6;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Load_LabelTag_16747_3();
                Bind_ReadTag_31286_6();
                Bind_ListTag_73286_8();
            }
        }
    }

    public void Load_LabelTag_16747_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16747_3.Controls.Add(uc_label);
    }

    public void Bind_ReadTag_31286_6()
    {
        /*id=request.cid*/
        long long_cid = long.MinValue;
        long.TryParse("" + Request.QueryString["cid"],out long_cid);
        ReadTag_31286_6 = Db_Context.Category
                .Where( b=>
                     b.ID == long_cid
                    )
                .FirstOrDefault();
        if (ReadTag_31286_6 == null)
        {
            ReadTag_31286_6 = new Category();
        }
    }

    public void Bind_ListTag_73286_8()
    {
        ...
        PagerTag_17286_15.Text = "<div id='pager'>" + pager.MakeLinks() +"</div>"; 
        if (list.Count() == 0)
        {
            empty_ListTag_73286_8.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_73286_8.DataSource = list.ToList();
        ListTag_73286_8.DataBind();
    }
