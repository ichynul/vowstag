...
{
    protected Category ReadTag_31621_6;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ReadTag_31621_6();
                Bind_ListTag_73629_8();
                Load_LabelTag_16783_3();
            }
        }
    }

    public void Bind_ReadTag_31621_6()
    {
        /*id=request.cid*/
        long long_cid = long.MinValue;
        long.TryParse("" + Request.QueryString["cid"],out long_cid);
        ReadTag_31621_6 = Db_Context.Category
                .Where( b=>
                     b.ID == long_cid
                    )
                .FirstOrDefault();
        if (ReadTag_31621_6 == null)
        {
            ReadTag_31621_6 = new Category();
        }
    }

    public void Bind_ListTag_73629_8()
    {
        ...
        if (totalsize > 4)
        {
            ...
            PagerTag_17775_15.Text = "<div id='pager' class='mypager'>" + pager.MakeLinks() +"</div>"; 
        }
        string urlparams = RemovePageParams(Request.RawUrl);
        PagerTag_17775_15.Text += "\r\n<div id='pagerinfo' style='display:none;'>"
        ...
        if (totalsize == 0)
        {
            empty_ListTag_73629_8.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_73629_8.DataSource = list.ToList();
        ListTag_73629_8.DataBind();
    }

    public void Load_LabelTag_16783_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16783_3.Controls.Add(uc_label);
    }
