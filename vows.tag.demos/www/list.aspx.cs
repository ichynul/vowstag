...
{
    protected Category ReadTag_31997_6;
    ...
    public void Bind_ReadTag_31997_6()
    {
        /*id=request.cid*/
        long long_cid = long.MinValue;
        long.TryParse("" + Request.QueryString["cid"],out long_cid);
        ReadTag_31997_6 = Db_Context.Category
                .Where( b=>
                     b.ID == long_cid
                    )
                .FirstOrDefault();
        if (ReadTag_31997_6 == null)
        {
            ReadTag_31997_6 = new Category();
        }
    }

    public void Bind_ListTag_7319_8()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_7319_8.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_7319_8.DataSource = list.ToList();
        ListTag_7319_8.DataBind();
    }

    public void Load_LabelTag_16598_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16598_3.Controls.Add(uc_label);
    }
