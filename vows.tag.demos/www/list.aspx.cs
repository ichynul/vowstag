...
{
    protected Category ReadTag_31639_6;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ReadTag_31639_6();
                Bind_ListTag_73162_8();
                Load_LabelTag_16175_3();
            }
        }
    }

    public void Bind_ReadTag_31639_6()
    {
        /*id=request.cid*/
        long long_cid = long.MinValue;
        long.TryParse("" + Request.QueryString["cid"],out long_cid);
        ReadTag_31639_6 = Db_Context.Category
                .Where( b=>
                     b.ID == long_cid
                    )
                .FirstOrDefault();
        if (ReadTag_31639_6 == null)
        {
            ReadTag_31639_6 = new Category();
        }
    }

    public void Bind_ListTag_73162_8()
    {
        ...
        /*分页，每页显示4;*/
        Pager pager= new Pager(totalsize, page, 4,Request.RawUrl, 3, "上一页", "下一页", "...", true);
        PagerTag_17684_15.Text = "<div id='pager' class='mypager'>" + pager.MakeLinks() +"</div>"; 
        string urlparams = RemovePageParams(Request.RawUrl);
        PagerTag_17684_15.Text = "<div id='pagerinfo' style='display:none;'>"
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_73162_8.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_73162_8.DataSource = list.ToList();
        ListTag_73162_8.DataBind();
    }

    public void Load_LabelTag_16175_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16175_3.Controls.Add(uc_label);
    }
