...
public partial class Page_jsonTag : xx.yy.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_45801_6();
                Load_LabelTag_16196_3();
            }
        }
    }

    public void Bind_ListTag_45801_6()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_45801_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_45801_6.DataSource = list.ToList();
        ListTag_45801_6.DataBind();
    }

    public void Load_LabelTag_16196_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16196_3.Controls.Add(uc_label);
    }

    public CallbackResult CallBack_JsonTag_71769_11()
    {
        /*orderby=时间&pagesize=3&fields=title,时间,time,desc,img,id*/
        string jsonname = this.CallValue("jsonname");
        if (jsonname != "JsonTag_71769_11")
        {
            return null;
        }
        ...
        json.jsonname = "JsonTag_71769_11";
    ...
    public CallbackResult CallBack_JsonTag_85915_12()
    {
        /*orderby=time&pagesize=3&fields=title,time,desc,img,id&categ=call.cid*/
        string jsonname = this.CallValue("jsonname");
        if (jsonname != "JsonTag_85915_12")
        {
            return null;
        }
        ...
        list = list.OrderByDescending(c=>c.Time).Skip((__page - 1) * 3).Take(3);
        dynamic json = new ExpandoObject();
        json.jsonname = "JsonTag_85915_12";
    ...
    public override CallbackResult TagCallback()
    {
        ...
        callback = CallBack_JsonTag_71769_11();
        if (callback != null)
        {
            return callback;
        }
        callback = CallBack_JsonTag_85915_12();
        if (callback != null)
        {
            return callback;
        }
