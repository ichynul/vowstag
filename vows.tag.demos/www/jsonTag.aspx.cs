...
public partial class Page_jsonTag : xx.yy.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_45501_6();
                Load_LabelTag_16272_3();
            }
        }
    }

    public void Bind_ListTag_45501_6()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_45501_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_45501_6.DataSource = list.ToList();
        ListTag_45501_6.DataBind();
    }

    public void Load_LabelTag_16272_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16272_3.Controls.Add(uc_label);
    }

    public CallbackResult CallBack_JsonTag_82275_11()
    {
        /*orderby=时间&desc=false&pagesize=3&fields=title,时间,time,desc,img,id*/
        string jsonname = this.CallValue("jsonname");
        if (jsonname != "JsonTag_82275_11")
        {
            return null;
        }
        ...
        json.jsonname = "JsonTag_82275_11";
    ...
    public CallbackResult CallBack_JsonTag_85173_12()
    {
        /*orderby=time&pagesize=3&fields=title,time,desc,img,id&categ=call.cid*/
        string jsonname = this.CallValue("jsonname");
        if (jsonname != "JsonTag_85173_12")
        {
            return null;
        }
        bool ifEqual_cid_4 = "categ" == CallString["cid"];
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
                     ifEqual_cid_4 
                    )
        ...
        dynamic json = new ExpandoObject();
        json.jsonname = "JsonTag_85173_12";
    ...
    public override CallbackResult TagCallback()
    {
        ...
        callback = CallBack_JsonTag_82275_11();
        if (callback != null)
        {
            return callback;
        }
        callback = CallBack_JsonTag_85173_12();
        if (callback != null)
        {
            return callback;
        }
