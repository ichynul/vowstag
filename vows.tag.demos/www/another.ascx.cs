...
{
    protected Article ReadTag_20897_1;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ReadTag_20897_1();
            }
        }
    }

    public void Bind_ReadTag_20897_1()
    {
        /*id=4*/
        ReadTag_20897_1 = Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
                     b.ID == 4
                    )
                .FirstOrDefault();
        if (ReadTag_20897_1 == null)
        {
            ReadTag_20897_1 = new Article();
        }
    }
