...
{
    protected Article ReadTag_2094_1;
    ...
    public void Bind_ReadTag_2094_1()
    {
        /*id=4*/
        ReadTag_2094_1 = Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
                     b.ID == 4
                    )
                .FirstOrDefault();
        if (ReadTag_2094_1 == null)
        {
            ReadTag_2094_1 = new Article();
        }
    }
