...
public partial class Control_artiel_by_categ : SubControl
{
    ...
    public void Bind_ListTag_6544_3()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_6544_3.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_6544_3.DataSource = list.ToList();
        ListTag_6544_3.DataBind();
    }
