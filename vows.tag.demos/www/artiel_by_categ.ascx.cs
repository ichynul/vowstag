...
public partial class Control_artiel_by_categ : SubControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_65579_3();
            }
        }
    }

    public void Bind_ListTag_65579_3()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_65579_3.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_65579_3.DataSource = list.ToList();
        ListTag_65579_3.DataBind();
    }
