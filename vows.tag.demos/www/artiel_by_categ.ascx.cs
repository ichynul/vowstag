...
public partial class Control_artiel_by_categ : SubControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_65407_3();
            }
        }
    }

    public void Bind_ListTag_65407_3()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_65407_3.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_65407_3.DataSource = list.ToList();
        ListTag_65407_3.DataBind();
    }
