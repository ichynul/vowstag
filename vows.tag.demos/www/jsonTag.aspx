...
<body>
    <div class="head">
        <asp:PlaceHolder ID="LabelTag_1668_3" runat="server"></asp:PlaceHolder><!--引入label--></div>
    <div class="navi">
        <ul class="navilist">
    <li><a href="/">首页</a></li>
...
<asp:Repeater ID="ListTag_4556_6" runat="server">
    <ItemTemplate>
                <li><a href="javascript:;" onclick="change(this,'<%# Eval("ID") %>');"><%# Eval("Name") %></a></li>
                </ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_4556_6" runat="server"></asp:Literal>
