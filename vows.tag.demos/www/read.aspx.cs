       ...
       /*重新指定了页面处理类，请确保 xx.yy.Read 直接或间接继承自'Tag.Vows.Web.TagPage'*/
{
    ...
    protected Category ReadTag_30544_9;
    protected bool ListTag_55589_23Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ReadTag_30916_5();
                Load_LabelTag_16439_6();
                Bind_ReadTag_30544_9();
                Bind_ListTag_7167_20();
                Bind_ListTag_55589_23();
            }
        }
    }

    public void Bind_ReadTag_30916_5()
    {
        /*id=request.id*/
    ...
    public void Load_LabelTag_16439_6()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16439_6.Controls.Add(uc_label);
    }

    public void Bind_ReadTag_30544_9()
    {
        /*id=read.categ*/
        int int_Categ_1 = read == null || !read.Categ.HasValue ? int.MinValue : read.Categ.Value;
;
        ReadTag_30544_9 = Db_Context.Category
                .Where( b=>
                     b.ID == int_Categ_1
                    )
                .FirstOrDefault();
        if (ReadTag_30544_9 == null)
        {
            ReadTag_30544_9 = new Category();
        }
    }

    public void Bind_ListTag_7167_20()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_7167_20.Text = "<div class='emptydiv'><span class='emptytext'>没有了</span></div>";
            return;
        }
        ListTag_7167_20.DataSource = list.ToList();
        ListTag_7167_20.DataBind();
    }

    public void Bind_ListTag_55589_23()
    {
        ...
        if (list.Count() == 0)
        {
            ListTag_55589_23Empty = true;
            return;
        }
        ListTag_55589_23.DataSource = list.ToList();
        ListTag_55589_23.DataBind();
    }
