...
public partial class Page_read : xx.yy.Read
{
    ...
    protected Category ReadTag_30685_9;
    protected bool ListTag_55828_23Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ReadTag_30507_5();
                Bind_ReadTag_30685_9();
                Bind_ListTag_71566_20();
                Bind_ListTag_55828_23();
                Load_LabelTag_16486_6();
            }
        }
    }

    public void Bind_ReadTag_30507_5()
    {
        /*id=request.id*/
    ...
    public void Bind_ReadTag_30685_9()
    {
        /*id=read.categ*/
        int int_Categ_1 = read == null || !read.Categ.HasValue ? int.MinValue : read.Categ.Value;
;
        ReadTag_30685_9 = Db_Context.Category
                .Where( b=>
                     b.ID == int_Categ_1
                    )
                .FirstOrDefault();
        if (ReadTag_30685_9 == null)
        {
            ReadTag_30685_9 = new Category();
        }
    }

    public void Bind_ListTag_71566_20()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_71566_20.Text = "<div class='emptydiv'><span class='emptytext'>没有了</span></div>";
            return;
        }
        ListTag_71566_20.DataSource = list.ToList();
        ListTag_71566_20.DataBind();
    }

    public void Bind_ListTag_55828_23()
    {
        ...
        if (totalsize == 0)
        {
            ListTag_55828_23Empty = true;
            return;
        }
        ListTag_55828_23.DataSource = list.ToList();
        ListTag_55828_23.DataBind();
    }

    public void Load_LabelTag_16486_6()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16486_6.Controls.Add(uc_label);
    }
