...
.                Article.Where(x => x.IsLock != true).FirstOrDefault( b=>
    ...
    public void Bind_ListTag_71_14()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_71_14.Text = "<div class='emptydiv'><span class='emptytext'>没有了</span></div>";
            return;
        }
        ListTag_71_14.DataSource = list;
        ListTag_71_14.DataBind();
    }

    public void Bind_ListTag_55_17()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_55_17.Text = "<!--empty标签对，作用与emptytext差不多，但emptytext仅支持简单的文字，而empty可包含复杂的文本（如html） -->                <!-- -->                <span style=\"color: Red;\">没有了~</span>                <!-- -->                ";
            return;
        }
        ListTag_55_17.DataSource = list;
        ListTag_55_17.DataBind();
    }
