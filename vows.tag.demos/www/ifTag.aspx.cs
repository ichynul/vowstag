...
{
    protected bool ListTag_2689_6Empty = false;
    protected bool ListTag_37442_10Empty = false;
    ...
    public void Bind_ListTag_20120_4()
    {
        /*id>1*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_20120_4.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_20120_4.DataSource = list.ToList();
        ListTag_20120_4.DataBind();
    }

    public void Bind_ListTag_2689_6()
    {
        /*pagesize=3*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                    select new
        ...
        if (totalsize == 0)
        {
            ListTag_2689_6Empty = true;
            return;
        }
        ListTag_2689_6.DataSource = list.ToList();
        ListTag_2689_6.DataBind();
    }

    public void Bind_ListTag_37442_10()
    {
        ...
        if (totalsize == 0)
        {
            ListTag_37442_10Empty = true;
            return;
        }
        ListTag_37442_10.DataSource = list.ToList();
        ListTag_37442_10.DataBind();
    }

    public void Load_LabelTag_15479_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_15479_3.Controls.Add(uc_label);
    }
