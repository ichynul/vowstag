...
{
    protected bool ListTag_26238_6Empty = false;
    protected bool ListTag_37588_10Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            if ( (Request.QueryString["kwd"] =="22")
                ...
                {
                    Bind_ListTag_20975_4();
                }
                Bind_ListTag_26238_6();
                Bind_ListTag_37588_10();
            if ( (Request.QueryString["kwd"] =="22")
                    && (Request.QueryString["kwd"] =="2") )
                {
                    Load_LabelTag_15625_3();
                }
            }
        }
    }

    public void Bind_ListTag_20975_4()
    {
        /*id>1*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_20975_4.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_20975_4.DataSource = list.ToList();
        ListTag_20975_4.DataBind();
    }

    public void Bind_ListTag_26238_6()
    {
        /*pagesize=3*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                    select new
        ...
        if (totalsize == 0)
        {
            ListTag_26238_6Empty = true;
            return;
        }
        ListTag_26238_6.DataSource = list.ToList();
        ListTag_26238_6.DataBind();
    }

    public void Bind_ListTag_37588_10()
    {
        ...
        if (totalsize == 0)
        {
            ListTag_37588_10Empty = true;
            return;
        }
        ListTag_37588_10.DataSource = list.ToList();
        ListTag_37588_10.DataBind();
    }

    public void Load_LabelTag_15625_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_15625_3.Controls.Add(uc_label);
    }
