...
{
    protected bool ListTag_26394_6Empty = false;
    protected bool ListTag_37230_10Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            if ( (Request.QueryString["kwd"] =="22")
                ...
                {
                    Bind_ListTag_20127_4();
                }
                Bind_ListTag_26394_6();
                Bind_ListTag_37230_10();
            if ( (Request.QueryString["kwd"] =="22")
                    && (Request.QueryString["kwd"] =="2") )
                {
                    Load_LabelTag_15364_3();
                }
            }
        }
    }

    public void Bind_ListTag_20127_4()
    {
        /*id>1*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_20127_4.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_20127_4.DataSource = list.ToList();
        ListTag_20127_4.DataBind();
    }

    public void Bind_ListTag_26394_6()
    {
        /*pagesize=3*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                    select new
        ...
        if (totalsize == 0)
        {
            ListTag_26394_6Empty = true;
            return;
        }
        ListTag_26394_6.DataSource = list.ToList();
        ListTag_26394_6.DataBind();
    }

    public void Bind_ListTag_37230_10()
    {
        ...
        if (totalsize == 0)
        {
            ListTag_37230_10Empty = true;
            return;
        }
        ListTag_37230_10.DataSource = list.ToList();
        ListTag_37230_10.DataBind();
    }

    public void Load_LabelTag_15364_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_15364_3.Controls.Add(uc_label);
    }
