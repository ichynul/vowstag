...
public partial class Page_formTag : xx.yy.PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ReadTag_30539_8();
                Load_LabelTag_16167_5();
            }
        }
    }

    public void Bind_ReadTag_30539_8()
    {
        /*id=request.id*/
    ...
    public override CallbackResult TagCallback()
    {
        ...
        callback = CallBack_FormTag_65901_9();
        if (callback != null)
        {
            return callback;
        }
