       ...
       /*重新指定了页面处理类，请确保 xx.yy.PageBase 直接或间接继承自'Tag.Vows.Web.TagPage'*/
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Load_LabelTag_16722_5();
                Bind_ReadTag_30350_8();
            }
        }
    }

    public void Load_LabelTag_16722_5()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16722_5.Controls.Add(uc_label);
    }

    public void Bind_ReadTag_30350_8()
    {
        /*id=request.id*/
    ...
    public override CallbackResult TagCallback()
    {
        ...
        callback = CallBack_FormTag_65872_9();
        if (callback != null)
        {
            return callback;
        }
