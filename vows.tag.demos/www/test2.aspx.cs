...
public partial class Page_test2 : xx.yy.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_44988_1();
                Bind_ListTag_44787_5();
            }
        }
    }

    public void Bind_ListTag_44988_1()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_44988_1.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_44988_1.DataSource = list.ToList();
        ListTag_44988_1.DataBind();
    }

    public void Bind_ListTag_44787_5()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_44787_5.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_44787_5.DataSource = list.ToList();
        ListTag_44787_5.DataBind();
    }
