...
public partial class Page_test2 : xx.yy.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_44597_1();
                Bind_ListTag_44358_5();
            }
        }
    }

    public void Bind_ListTag_44597_1()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_44597_1.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_44597_1.DataSource = list.ToList();
        ListTag_44597_1.DataBind();
    }

    public void Bind_ListTag_44358_5()
    {
        /*url.type="4"&id=4&pagesize=3*/
        bool ifEqual_type_1 = "4" == Request.QueryString["type"];
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
                     ifEqual_type_1 
                     && b.ID == 4
        ...
        if (totalsize == 0)
        {
            empty_ListTag_44358_5.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_44358_5.DataSource = list.ToList();
        ListTag_44358_5.DataBind();
    }
