...
<body>
    <div class="head">
        <asp:PlaceHolder ID="LabelTag_16671_3" runat="server"></asp:PlaceHolder><!--引入label-->
    ...
    <div class="main">
        <div class="articles">
            <asp:PlaceHolder ID="ListTag_67816_5" runat="server"></asp:PlaceHolder>
<asp:Literal ID="empty_ListTag_67816_5" runat="server"></asp:Literal>
