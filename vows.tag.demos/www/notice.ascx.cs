...
public partial class Control_notice : SubControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_46849_1();
                Load_LabelTag_16849_4();
            }
        }
    }

    public void Bind_ListTag_46849_1()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_46849_1.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_46849_1.DataSource = list.ToList();
        ListTag_46849_1.DataBind();
    }

    public void Load_LabelTag_16849_4()
    {
        SubControl uc_label=(SubControl) LoadControl( "another.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16849_4.Controls.Add(uc_label);
    }
