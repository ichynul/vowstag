...
public partial class Control_notice : SubControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_4671_1();
                Load_LabelTag_16866_4();
            }
        }
    }

    public void Bind_ListTag_4671_1()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_4671_1.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_4671_1.DataSource = list.ToList();
        ListTag_4671_1.DataBind();
    }

    public void Load_LabelTag_16866_4()
    {
        SubControl uc_label=(SubControl) LoadControl( "another.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16866_4.Controls.Add(uc_label);
    }
