...
public partial class Control_notice : SubControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_46568_1();
                Load_LabelTag_16651_4();
            }
        }
    }

    public void Bind_ListTag_46568_1()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_46568_1.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_46568_1.DataSource = list.ToList();
        ListTag_46568_1.DataBind();
    }
