...
<% { %>
            <asp:PlaceHolder ID="LabelTag_15479_3" runat="server"></asp:PlaceHolder>
            <% if (Request.QueryString["xx"]=="oo") %>
<% { %>
                
<asp:Repeater ID="ListTag_20120_4" runat="server">
    <ItemTemplate>
                    <%# Eval("Title") %>
                </ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_20120_4" runat="server"></asp:Literal>
    ...
    <% } %>
<asp:Repeater ID="ListTag_2689_6" runat="server">
    <ItemTemplate><!--分页3条-->
        <li><a class="title" href="formTag.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
            ...
            <% if (ListTag_2689_6Empty) %>
<% { %>

                xxoo
            
<% } %>
<asp:Repeater ID="ListTag_37442_10" runat="server">
    <ItemTemplate><!--分页3条-->
        <li><a class="title" href="formTag.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
            <%# Eval("Time") %></span> </li>
