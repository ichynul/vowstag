...
<% { %>
            <asp:PlaceHolder ID="LabelTag_15364_3" runat="server"></asp:PlaceHolder>
            <% if (Request.QueryString["xx"]=="oo") %>
<% { %>
                
<asp:Repeater ID="ListTag_20127_4" runat="server">
    <ItemTemplate>
                    <%# Eval("Title") %>
                </ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_20127_4" runat="server"></asp:Literal>
    ...
    <% } %>
<asp:Repeater ID="ListTag_26394_6" runat="server">
    <ItemTemplate><!--分页3条-->
        <li><a class="title" href="formTag.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
            ...
            <% if (ListTag_26394_6Empty) %>
<% { %>

                xxoo
            
<% } %>
<asp:Repeater ID="ListTag_37230_10" runat="server">
    <ItemTemplate><!--分页3条-->
        <li><a class="title" href="formTag.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
            <%# Eval("Time") %></span> </li>
