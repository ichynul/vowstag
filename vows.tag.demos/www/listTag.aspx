...
<body>
    <div class="head">
        <asp:PlaceHolder ID="LabelTag_16446_3" runat="server"></asp:PlaceHolder><!--引入label-->
    </div>
    <div class="navi">
        <ul class="navilist">
    <li><a href="/">首页</a></li>
...
<asp:Repeater ID="ListTag_26766_6" runat="server">
    <ItemTemplate><!--分页3条-->
                <li><a class="title" href="formTag.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
                    <%# Eval("Time") %></span> </li>
                </ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_26766_6" runat="server"></asp:Literal>

            </ul>
            <div id="kkpager" class="tcdPageCode">
            </div>
            <!-- 分页标签，一个页面最多只能有一个分页的list，最多一个分页标签-->
            <asp:Literal ID="PagerTag_17955_10" runat="server"></asp:Literal><!--tpey=js，前端分页(可以用第三方分页实现个性化分页)，会在标签出输出分页需要的隐藏信息 -->
            <div>
                <h4>
                    ----输出分页信息----</h4>
...
<asp:Repeater ID="ListTag_41914_11" runat="server">
    <ItemTemplate><li><a class="title" href="read.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
    <%# Eval("Time") %></span> </li>
</ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_41914_11" runat="server"></asp:Literal>
...
<asp:Repeater ID="ListTag_54463_12" runat="server">
    <ItemTemplate><li><a class="title" href="read.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
    <%# Eval("Time") %></span> </li>
</ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_54463_12" runat="server"></asp:Literal>
...
<asp:Repeater ID="ListTag_77341_13" runat="server">
    <ItemTemplate><li><a class="title" href="read.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
    <%# Eval("Time") %></span> </li>
</ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_77341_13" runat="server"></asp:Literal>
...
<asp:Repeater ID="ListTag_66576_14" runat="server">
    <ItemTemplate><li><a class="title" href="read.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
    <%# Eval("Time") %></span> </li>
</ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_66576_14" runat="server"></asp:Literal>
...
<asp:Repeater ID="ListTag_89248_15" runat="server">
    <ItemTemplate><li><a class="title" href="read.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
    <%# Eval("Time") %></span> </li>
</ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_89248_15" runat="server"></asp:Literal>
...
<asp:Repeater ID="ListTag_60395_16" runat="server">
    <ItemTemplate><li><a class="title" href="read.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
    <%# Eval("Time") %></span> </li>
</ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_60395_16" runat="server"></asp:Literal>
...
<asp:Repeater ID="ListTag_76304_21" runat="server">
    <ItemTemplate><li><a class="title" href="read.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
    <%# Eval("Time") %></span> </li>
</ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_76304_21" runat="server"></asp:Literal>
...
<asp:Repeater ID="ListTag_107400_22" runat="server">
    <ItemTemplate><li><a class="title" href="read.aspx?id=<%# Eval("ID") %>"><%# Eval("Title") %></a> <span class="time">
    <%# Eval("Time") %></span> </li>
</ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_107400_22" runat="server"></asp:Literal>
...
<asp:Repeater ID="ListTag_22259_23" runat="server">
    <ItemTemplate><!--受保护的表'Admin'，无法使用-->
                <li>用户名：<%# Eval("Username") %><br />
                    密码：<%# Eval("Password") %></li>
                </ItemTemplate>
</asp:Repeater>
<asp:Literal ID="empty_ListTag_22259_23" runat="server"></asp:Literal>
