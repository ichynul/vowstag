...
public partial class Page_index : xx.yy.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_67928_5();
                Load_LabelTag_1671_3();
            }
        }
    }

    public void Bind_ListTag_67928_5()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_67928_5.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
