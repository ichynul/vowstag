...
{
    protected Article ReadTag_17240_5;
    ...
    public void Bind_ReadTag_17240_5()
    {
        /*主键ID=4*/
        ReadTag_17240_5 = Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
                     b.ID == 4
                    )
                .FirstOrDefault();
        if (ReadTag_17240_5 == null)
        {
            ReadTag_17240_5 = new Article();
        }
    }

    public void Bind_ListTag_24413_1()
    {
        /*主键ID>3&take=3*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_24413_1.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_24413_1.DataSource = list.ToList();
        ListTag_24413_1.DataBind();
    }

    public void Bind_ListTag_57656_9()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_57656_9.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_57656_9.DataSource = list.ToList();
        ListTag_57656_9.DataBind();
    }
