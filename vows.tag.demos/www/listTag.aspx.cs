...
public partial class Page_listTag : xx.yy.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_26433_6();
                Bind_ListTag_41478_11();
                Bind_ListTag_541_12();
                Bind_ListTag_77523_13();
                Bind_ListTag_67567_14();
                Bind_ListTag_76612_15();
                Bind_ListTag_82657_16();
                Bind_ListTag_22702_17();
                Load_LabelTag_1614_3();
            }
        }
    }

    public void Bind_ListTag_26433_6()
    {
        /*pagesize=3*/
        ...
        PagerTag_17955_10.Text = "<div id='pagerinfo' style='display:none;'>"
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_26433_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_26433_6.DataSource = list.ToList();
        ListTag_26433_6.DataBind();
    }
    ...
    public void Bind_ListTag_541_12()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_541_12.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_541_12.DataSource = list.ToList();
        ListTag_541_12.DataBind();
    }

    public void Bind_ListTag_77523_13()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_77523_13.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_77523_13.DataSource = list.ToList();
        ListTag_77523_13.DataBind();
    }

    public void Bind_ListTag_67567_14()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_67567_14.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_67567_14.DataSource = list.ToList();
        ListTag_67567_14.DataBind();
    }

    public void Bind_ListTag_76612_15()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_76612_15.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_76612_15.DataSource = list.ToList();
        ListTag_76612_15.DataBind();
    }

    public void Bind_ListTag_82657_16()
    {
        ...
        if (list.Count() == 0)
        {
            empty_ListTag_82657_16.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_82657_16.DataSource = list.ToList();
        ListTag_82657_16.DataBind();
    }

    public void Bind_ListTag_22702_17()
    {
        /*数据表admin已被设置为不可用，您无权操作该表！*/
    }

    public void Load_LabelTag_1614_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_1614_3.Controls.Add(uc_label);
    }
