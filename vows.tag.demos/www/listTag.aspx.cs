...
{
    protected bool ListTag_20333_17Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_26354_6();
                Bind_ListTag_41974_11();
                Bind_ListTag_54150_12();
                Bind_ListTag_77944_13();
                Bind_ListTag_66330_14();
                Bind_ListTag_89947_15();
                Bind_ListTag_60937_16();
                Bind_ListTag_20333_17();
                Bind_ListTag_7687_21();
                Bind_ListTag_107957_22();
                Bind_ListTag_22713_23();
                Load_LabelTag_16894_3();
            }
        }
    }

    public void Bind_ListTag_26354_6()
    {
        /*pagesize=3*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_26354_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_26354_6.DataSource = list.ToList();
        ListTag_26354_6.DataBind();
    }

    public void Bind_ListTag_41974_11()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_41974_11.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_41974_11.DataSource = list.ToList();
        ListTag_41974_11.DataBind();
    }

    public void Bind_ListTag_54150_12()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_54150_12.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_54150_12.DataSource = list.ToList();
        ListTag_54150_12.DataBind();
    }

    public void Bind_ListTag_77944_13()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_77944_13.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_77944_13.DataSource = list.ToList();
        ListTag_77944_13.DataBind();
    }

    public void Bind_ListTag_66330_14()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_66330_14.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_66330_14.DataSource = list.ToList();
        ListTag_66330_14.DataBind();
    }

    public void Bind_ListTag_89947_15()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_89947_15.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_89947_15.DataSource = list.ToList();
        ListTag_89947_15.DataBind();
    }

    public void Bind_ListTag_60937_16()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_60937_16.Text = "<div class='emptydiv'><span class='emptytext'>没有id小于0的记录</span></div>";
            return;
        }
        ListTag_60937_16.DataSource = list.ToList();
        ListTag_60937_16.DataBind();
    }

    public void Bind_ListTag_20333_17()
    {
        /*id<0*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
        ...
        if (totalsize == 0)
        {
            ListTag_20333_17Empty = true;
            return;
        }
        ListTag_20333_17.DataSource = list.ToList();
        ListTag_20333_17.DataBind();
    }

    public void Bind_ListTag_7687_21()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_7687_21.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_7687_21.DataSource = list.ToList();
        ListTag_7687_21.DataBind();
    }

    public void Bind_ListTag_107957_22()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_107957_22.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_107957_22.DataSource = list.ToList();
        ListTag_107957_22.DataBind();
    }

    public void Bind_ListTag_22713_23()
    {
        /*数据表admin已被设置为不可用，您无权操作该表！*/
    }

    public void Load_LabelTag_16894_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16894_3.Controls.Add(uc_label);
    }
