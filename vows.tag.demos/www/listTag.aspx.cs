...
{
    protected bool ListTag_2059_17Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_26766_6();
                Bind_ListTag_41914_11();
                Bind_ListTag_54463_12();
                Bind_ListTag_77341_13();
                Bind_ListTag_66576_14();
                Bind_ListTag_89248_15();
                Bind_ListTag_60395_16();
                Bind_ListTag_2059_17();
                Bind_ListTag_76304_21();
                Bind_ListTag_107400_22();
                Bind_ListTag_22259_23();
                Load_LabelTag_16446_3();
            }
        }
    }

    public void Bind_ListTag_26766_6()
    {
        /*pagesize=3*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_26766_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_26766_6.DataSource = list.ToList();
        ListTag_26766_6.DataBind();
    }

    public void Bind_ListTag_41914_11()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_41914_11.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_41914_11.DataSource = list.ToList();
        ListTag_41914_11.DataBind();
    }

    public void Bind_ListTag_54463_12()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_54463_12.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_54463_12.DataSource = list.ToList();
        ListTag_54463_12.DataBind();
    }

    public void Bind_ListTag_77341_13()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_77341_13.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_77341_13.DataSource = list.ToList();
        ListTag_77341_13.DataBind();
    }

    public void Bind_ListTag_66576_14()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_66576_14.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_66576_14.DataSource = list.ToList();
        ListTag_66576_14.DataBind();
    }

    public void Bind_ListTag_89248_15()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_89248_15.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_89248_15.DataSource = list.ToList();
        ListTag_89248_15.DataBind();
    }

    public void Bind_ListTag_60395_16()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_60395_16.Text = "<div class='emptydiv'><span class='emptytext'>没有id小于0的记录</span></div>";
            return;
        }
        ListTag_60395_16.DataSource = list.ToList();
        ListTag_60395_16.DataBind();
    }

    public void Bind_ListTag_2059_17()
    {
        /*id<0*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
        ...
        if (totalsize == 0)
        {
            ListTag_2059_17Empty = true;
            return;
        }
        ListTag_2059_17.DataSource = list.ToList();
        ListTag_2059_17.DataBind();
    }

    public void Bind_ListTag_76304_21()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_76304_21.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_76304_21.DataSource = list.ToList();
        ListTag_76304_21.DataBind();
    }

    public void Bind_ListTag_107400_22()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_107400_22.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_107400_22.DataSource = list.ToList();
        ListTag_107400_22.DataBind();
    }

    public void Bind_ListTag_22259_23()
    {
        /*数据表admin已被设置为不可用，您无权操作该表！*/
    }

    public void Load_LabelTag_16446_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16446_3.Controls.Add(uc_label);
    }
