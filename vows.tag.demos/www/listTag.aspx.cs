...
{
    protected bool ListTag_20336_17Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_2684_6();
                Bind_ListTag_41101_11();
                Bind_ListTag_54963_12();
                Bind_ListTag_77179_13();
                Bind_ListTag_66418_14();
                Bind_ListTag_8946_15();
                Bind_ListTag_60669_16();
                Bind_ListTag_20336_17();
                Bind_ListTag_76284_21();
                Bind_ListTag_107557_22();
                Bind_ListTag_22942_23();
                Load_LabelTag_16824_3();
            }
        }
    }

    public void Bind_ListTag_2684_6()
    {
        /*pagesize=3*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_2684_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_2684_6.DataSource = list.ToList();
        ListTag_2684_6.DataBind();
    }

    public void Bind_ListTag_41101_11()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_41101_11.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_41101_11.DataSource = list.ToList();
        ListTag_41101_11.DataBind();
    }

    public void Bind_ListTag_54963_12()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_54963_12.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_54963_12.DataSource = list.ToList();
        ListTag_54963_12.DataBind();
    }

    public void Bind_ListTag_77179_13()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_77179_13.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_77179_13.DataSource = list.ToList();
        ListTag_77179_13.DataBind();
    }

    public void Bind_ListTag_66418_14()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_66418_14.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_66418_14.DataSource = list.ToList();
        ListTag_66418_14.DataBind();
    }

    public void Bind_ListTag_8946_15()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_8946_15.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_8946_15.DataSource = list.ToList();
        ListTag_8946_15.DataBind();
    }

    public void Bind_ListTag_60669_16()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_60669_16.Text = "<div class='emptydiv'><span class='emptytext'>没有id小于0的记录</span></div>";
            return;
        }
        ListTag_60669_16.DataSource = list.ToList();
        ListTag_60669_16.DataBind();
    }

    public void Bind_ListTag_20336_17()
    {
        /*id<0*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
        ...
        if (totalsize == 0)
        {
            ListTag_20336_17Empty = true;
            return;
        }
        ListTag_20336_17.DataSource = list.ToList();
        ListTag_20336_17.DataBind();
    }

    public void Bind_ListTag_76284_21()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_76284_21.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_76284_21.DataSource = list.ToList();
        ListTag_76284_21.DataBind();
    }

    public void Bind_ListTag_107557_22()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_107557_22.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_107557_22.DataSource = list.ToList();
        ListTag_107557_22.DataBind();
    }

    public void Bind_ListTag_22942_23()
    {
        /*数据表admin已被设置为不可用，您无权操作该表！*/
    }

    public void Load_LabelTag_16824_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16824_3.Controls.Add(uc_label);
    }
