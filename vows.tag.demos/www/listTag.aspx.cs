...
{
    protected bool ListTag_20566_17Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_26630_6();
                Bind_ListTag_41668_11();
                Bind_ListTag_54482_12();
                Bind_ListTag_77871_13();
                Bind_ListTag_66944_14();
                Bind_ListTag_89168_15();
                Bind_ListTag_60938_16();
                Bind_ListTag_20566_17();
                Bind_ListTag_76205_21();
                Bind_ListTag_107731_22();
                Bind_ListTag_22762_23();
                Load_LabelTag_1681_3();
            }
        }
    }

    public void Bind_ListTag_26630_6()
    {
        /*pagesize=3*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_26630_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_26630_6.DataSource = list.ToList();
        ListTag_26630_6.DataBind();
    }

    public void Bind_ListTag_41668_11()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_41668_11.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_41668_11.DataSource = list.ToList();
        ListTag_41668_11.DataBind();
    }

    public void Bind_ListTag_54482_12()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_54482_12.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_54482_12.DataSource = list.ToList();
        ListTag_54482_12.DataBind();
    }

    public void Bind_ListTag_77871_13()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_77871_13.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_77871_13.DataSource = list.ToList();
        ListTag_77871_13.DataBind();
    }

    public void Bind_ListTag_66944_14()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_66944_14.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_66944_14.DataSource = list.ToList();
        ListTag_66944_14.DataBind();
    }

    public void Bind_ListTag_89168_15()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_89168_15.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_89168_15.DataSource = list.ToList();
        ListTag_89168_15.DataBind();
    }

    public void Bind_ListTag_60938_16()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_60938_16.Text = "<div class='emptydiv'><span class='emptytext'>没有id小于0的记录</span></div>";
            return;
        }
        ListTag_60938_16.DataSource = list.ToList();
        ListTag_60938_16.DataBind();
    }

    public void Bind_ListTag_20566_17()
    {
        /*id<0*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
        ...
        if (totalsize == 0)
        {
            ListTag_20566_17Empty = true;
            return;
        }
        ListTag_20566_17.DataSource = list.ToList();
        ListTag_20566_17.DataBind();
    }

    public void Bind_ListTag_76205_21()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_76205_21.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_76205_21.DataSource = list.ToList();
        ListTag_76205_21.DataBind();
    }

    public void Bind_ListTag_107731_22()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_107731_22.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_107731_22.DataSource = list.ToList();
        ListTag_107731_22.DataBind();
    }

    public void Bind_ListTag_22762_23()
    {
        /*数据表admin已被设置为不可用，您无权操作该表！*/
    }

    public void Load_LabelTag_1681_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_1681_3.Controls.Add(uc_label);
    }
