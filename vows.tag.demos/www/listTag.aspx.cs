...
{
    protected bool ListTag_20682_17Empty = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_26431_6();
                Bind_ListTag_41478_11();
                Bind_ListTag_54250_12();
                Bind_ListTag_77838_13();
                Bind_ListTag_66457_14();
                Bind_ListTag_89853_15();
                Bind_ListTag_6029_16();
                Bind_ListTag_20682_17();
                Bind_ListTag_76313_21();
                Bind_ListTag_107547_22();
                Bind_ListTag_22555_23();
                Load_LabelTag_16486_3();
            }
        }
    }

    public void Bind_ListTag_26431_6()
    {
        /*pagesize=3*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_26431_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_26431_6.DataSource = list.ToList();
        ListTag_26431_6.DataBind();
    }

    public void Bind_ListTag_41478_11()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_41478_11.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_41478_11.DataSource = list.ToList();
        ListTag_41478_11.DataBind();
    }

    public void Bind_ListTag_54250_12()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_54250_12.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_54250_12.DataSource = list.ToList();
        ListTag_54250_12.DataBind();
    }

    public void Bind_ListTag_77838_13()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_77838_13.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_77838_13.DataSource = list.ToList();
        ListTag_77838_13.DataBind();
    }

    public void Bind_ListTag_66457_14()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_66457_14.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_66457_14.DataSource = list.ToList();
        ListTag_66457_14.DataBind();
    }

    public void Bind_ListTag_89853_15()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_89853_15.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_89853_15.DataSource = list.ToList();
        ListTag_89853_15.DataBind();
    }

    public void Bind_ListTag_6029_16()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_6029_16.Text = "<div class='emptydiv'><span class='emptytext'>没有id小于0的记录</span></div>";
            return;
        }
        ListTag_6029_16.DataSource = list.ToList();
        ListTag_6029_16.DataBind();
    }

    public void Bind_ListTag_20682_17()
    {
        /*id<0*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
        ...
        if (totalsize == 0)
        {
            ListTag_20682_17Empty = true;
            return;
        }
        ListTag_20682_17.DataSource = list.ToList();
        ListTag_20682_17.DataBind();
    }

    public void Bind_ListTag_76313_21()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_76313_21.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_76313_21.DataSource = list.ToList();
        ListTag_76313_21.DataBind();
    }

    public void Bind_ListTag_107547_22()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_107547_22.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_107547_22.DataSource = list.ToList();
        ListTag_107547_22.DataBind();
    }

    public void Bind_ListTag_22555_23()
    {
        /*数据表admin已被设置为不可用，您无权操作该表！*/
    }

    public void Load_LabelTag_16486_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16486_3.Controls.Add(uc_label);
    }
