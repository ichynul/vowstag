...
{
    protected bool ListTag_20544_17Empty = false;
    ...
    public void Bind_ListTag_26267_6()
    {
        /*pagesize=3*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_26267_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_26267_6.DataSource = list.ToList();
        ListTag_26267_6.DataBind();
    }

    public void Bind_ListTag_41661_11()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_41661_11.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_41661_11.DataSource = list.ToList();
        ListTag_41661_11.DataBind();
    }

    public void Bind_ListTag_54198_12()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_54198_12.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_54198_12.DataSource = list.ToList();
        ListTag_54198_12.DataBind();
    }

    public void Bind_ListTag_77390_13()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_77390_13.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_77390_13.DataSource = list.ToList();
        ListTag_77390_13.DataBind();
    }

    public void Bind_ListTag_66818_14()
    {
        /*title%O&content!%[二B]&title!%你好&item=listTag_item*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
                     b.Title.Contains("O"/* 全局变量? 如果是全局变量请写成this.O*/)
                     && !b.Content.Contains("二B")
                     && !b.Title.Contains("你好"/* 全局变量? 如果是全局变量请写成this.你好*/)
                    )
                    select new
                    {
                        a.ID,
        ...
        if (totalsize == 0)
        {
            empty_ListTag_66818_14.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_66818_14.DataSource = list.ToList();
        ListTag_66818_14.DataBind();
    }

    public void Bind_ListTag_89134_15()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_89134_15.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_89134_15.DataSource = list.ToList();
        ListTag_89134_15.DataBind();
    }

    public void Bind_ListTag_60327_16()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_60327_16.Text = "<div class='emptydiv'><span class='emptytext'>没有id小于0的记录</span></div>";
            return;
        }
        ListTag_60327_16.DataSource = list.ToList();
        ListTag_60327_16.DataBind();
    }

    public void Bind_ListTag_20544_17()
    {
        /*id<0*/
        var list = from a in Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
        ...
        if (totalsize == 0)
        {
            ListTag_20544_17Empty = true;
            return;
        }
        ListTag_20544_17.DataSource = list.ToList();
        ListTag_20544_17.DataBind();
    }

    public void Bind_ListTag_76903_21()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_76903_21.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_76903_21.DataSource = list.ToList();
        ListTag_76903_21.DataBind();
    }

    public void Bind_ListTag_107813_22()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_107813_22.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_107813_22.DataSource = list.ToList();
        ListTag_107813_22.DataBind();
    }

    public void Bind_ListTag_22342_23()
    {
        /*数据表admin已被设置为不可用，您无权操作该表！*/
    }

    public void Load_LabelTag_16623_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16623_3.Controls.Add(uc_label);
    }
