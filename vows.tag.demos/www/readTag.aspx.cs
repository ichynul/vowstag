...
public partial class Page_readTag : xx.yy.PageBase
{
    ...
    protected Article ReadTag_48669_17;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ReadTag_22629_4();
                Bind_ReadTag_48669_17();
                Bind_ListTag_68879_15();
                Load_LabelTag_16452_5();
            }
        }
    }

    public void Bind_ReadTag_22629_4()
    {
        /*id>10*/
    ...
    public void Bind_ReadTag_48669_17()
    {
        /*orderby=id&desc=false&id>read.id*/
        long long_ID_3 = read == null ? long.MinValue: read.ID;
        ReadTag_48669_17 = Db_Context.Article.Where(x => x.IsLock != true)
                .Where( b=>
                     b.ID > long_ID_3
                    ).OrderBy(c=>c.ID)
                .FirstOrDefault();
        if (ReadTag_48669_17 == null)
        {
            ReadTag_48669_17 = new Article();
        }
    }

    public void Bind_ListTag_68879_15()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_68879_15.Text = "<div class='emptydiv'><span class='emptytext'>没有了</span></div>";
            return;
        }
        ListTag_68879_15.DataSource = list.ToList();
        ListTag_68879_15.DataBind();
    }

    public void Load_LabelTag_16452_5()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16452_5.Controls.Add(uc_label);
    }
