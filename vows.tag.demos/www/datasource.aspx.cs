...
public partial class Page_datasource : xx.yy.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_39750_6();
                Bind_ListTag_31322_10();
                Load_LabelTag_16165_3();
            }
        }
    }

    public void Bind_ListTag_39750_6()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_39750_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_39750_6.DataSource = list.ToList();
        ListTag_39750_6.DataBind();
    }

    public void Bind_ListTag_31322_10()
    {
        /*id>cookie.id.id*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_31322_10.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_31322_10.DataSource = list.ToList();
        ListTag_31322_10.DataBind();
    }

    public void Load_LabelTag_16165_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_16165_3.Controls.Add(uc_label);
    }
