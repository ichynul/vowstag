...
public partial class Page_datasource : xx.yy.PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                Bind_ListTag_39314_6();
                Bind_ListTag_31749_10();
                Load_LabelTag_1612_3();
            }
        }
    }

    public void Bind_ListTag_39314_6()
    {
        ...
        if (totalsize == 0)
        {
            empty_ListTag_39314_6.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_39314_6.DataSource = list.ToList();
        ListTag_39314_6.DataBind();
    }

    public void Bind_ListTag_31749_10()
    {
        /*id>cookie.id.id*/
        ...
        if (totalsize == 0)
        {
            empty_ListTag_31749_10.Text = "<div class='emptydiv'><span class='emptytext'>暂无内容</span></div>";
            return;
        }
        ListTag_31749_10.DataSource = list.ToList();
        ListTag_31749_10.DataBind();
    }

    public void Load_LabelTag_1612_3()
    {
        SubControl uc_label=(SubControl) LoadControl( "notice.ascx");
        uc_label.SetDb(this.Db_Context);
        uc_label.SetConfig(this.config);
        LabelTag_1612_3.Controls.Add(uc_label);
    }
